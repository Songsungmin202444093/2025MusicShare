...
async function CelebDetailBody({ id }) {
  ...
  const celeb = data.celeb ?? { name: id, cover: null };
  ...
  return (
    <div className="container" style={{ padding: "14px 0" }}>
      ...
      <div className="card" style={{ marginTop: 12, padding: 0 }}>
        ...
        {tracks.map((row, idx) => (
          <div key={row.id ?? idx} style={{ display: "grid", gridTemplateColumns: "64px 200px 1fr 260px 200px", gap: 10, alignItems: "center", padding: "14px 16px", borderBottom: "1px solid var(--line)" }}>
